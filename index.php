...
<!-- heading -->
    <header>
      <center>
        <th> <I> <h1 style="color:white;font-size:100%;text-align:center">What's happening in the Room?</h1></I></th>
      </center>
    </header>
    <!-- date and day -->
    <BR>
    ...
    <script>
            ...
            $('#start').click(function() {
                var protocol = 'HLS';
                var streamName = 'raspi';

                // Step 1: Configure SDK Clients
                var options = {
                    accessKeyId: 'AKIAXDBLUXRMNTS2ULCL',
                    secretAccessKey: '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',
...
<!-- time,temp,humid,-->
      ...
      <!-- PHP CODE TO FETCH DATA FROM ROWS-->
            ...
            $sql = "SELECT * FROM roomdata.logdata ORDER BY ID DESC LIMIT 1;";
  ...
  <table style="width:100%">
    ...
    <tr>
      <td style="text-align:center;" ><?php echo $rows['TEMPERATURE'];?><span> &#8451;</span></td>
      <td style="text-align:center" ><?php echo $rows['HUMIDITY'];?> %</td>
    </tr>
    <?php } ?>
  ...
  <tr>
    ...
    <tr>
    <RIGHT><td><input type="submit" value = "SWITCH" ></button>
  </td></RIGHT></tr>
  </form>
</div>
  <?php
    ...
    if(isset($_GET['fan']))
      $fan = 1;
    $SQL = "INSERT INTO roomdata.logdata (ID,TEMPERATURE,HUMIDITY,LIGHT,FAN) VALUES (now(),'30','98.8',$light,$fan)";  
